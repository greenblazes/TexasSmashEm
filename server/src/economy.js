...
export const DEFAULTS = {
  ...
  disableParticipantCountdown: true, // if true, sealed-boon phase never auto-advances — waits for both participants
  disableSpectatorCountdown: true,   // if true, spectator turns never auto-advance — waits for each player's input
